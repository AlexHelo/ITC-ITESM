...
public class Main {
	public static void main(String args[]) {
		/*
		 * Instrucciones: Para ganar no tienes permitido modificar la clase Main Salvo
		 * por las instrucciones que vayas descubriendo. Para ganar debes completar
		 * todos los puntos del rally y probar tu solución con el Main del profesor.
